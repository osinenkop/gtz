...
\]
which gives the concrete bound $F(P)\ge 1/12$ in the case $(6,3)$.
...
bound $F(P)\ge 1/12$ for all $P\in\Gr(3,6)$.
...
\[
  ...
  =\lambda_{\max}\bigl((X_SX_S^T)^{-1}\bigr)
  \le \tr\bigl((X_SX_S^T)^{-1}\bigr)
  \le k(n-k+1).
\]
