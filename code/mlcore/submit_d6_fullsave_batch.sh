...
RUN_DIR="${RUN_DIR:-$ROOT/code/mlcore/watch/d6_fullsave}"
...
submit_support_job() {
  ...
  local prefix="gtz-d6full-${gtz_case}-p${prime}-c${candidate}"
...
for prime in 32003 32009 32027 32029 32051 32057; do
