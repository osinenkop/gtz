...
\begin{remark}
This subsection is still not a proof of the full inequality.  The exact
remaining step is to isolate the real roots on the certified branch and prove
the indicated active/inactive sign conditions with rational interval
arithmetic or an equivalent real-algebraic certificate.
\end{remark}
